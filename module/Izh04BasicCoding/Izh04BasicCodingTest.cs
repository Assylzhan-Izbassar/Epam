...
namespace Izh04BasicCoding
{
    ...
    class Izh04BasicCodingTest
    {
        ...
        public int CheckMaxElementFinding(int[] sourceArray)
        {
            ...
            //Assert
            return task.MaxElementFinding(sourceArray);//Add
        }

        [TestCase(new double[] { 2,3,4,5}, ExpectedResult = 2)] 
        [TestCase(new double[] { }, ExpectedResult = -1)]
        [TestCase(new double[] { 0, 1, 2, 3 }, ExpectedResult = -1)]
        [TestCase(new double[] { 5, 1, 2, 3 }, ExpectedResult = 1)]
        ...
        public int CheckFindingElementIndexBetweenEqualSums(double[] sourceArray)
        {
            ...
            //Assert
            return task.FindingElementIndexBetweenEqualSums(sourceArray);//Add
        }
        ...
        public string CheckStringConcatenation(string firstStr, string secondStr)
        {
            ...
            //Assert
            return task.StringConcatenation(firstStr, secondStr);//Add
        }
        ...
        public int[] CheckDigitFiltering(int[] sourceArray, int digit)
        {
            ...
            //Assert
            return task.FilterDigit(sourceArray, digit);//Add
        }
        ...
        public int CheckFindNextBiggerNumber(int number)
        {
            ...
            //Assert
            return task.FindNextBiggerNumber(number);//Add
        }
    }
}
