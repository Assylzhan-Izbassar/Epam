...
namespace OnlineShop.Migrations
{
    ...
    [Migration("20191223153147_UpdatedCommentTableDemo")]
    partial class UpdatedCommentTableDemo
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineShop.DAL.Model.Comment", b =>
                {
                    b.HasOne("OnlineShop.DAL.Model.Customer", "Customer")
                        .WithMany()
                        .HasForeignKey("CustomerID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OnlineShop.DAL.Model.Product", "Product")
                        .WithMany()
